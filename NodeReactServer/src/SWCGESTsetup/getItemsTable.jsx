...
export default function GetItemsTable(props){
  ...
  function addItem(){
    resetStates(props.fstate,'AddItem');
  }
  ...
  useEffect(() => {
    axios.post('http://localhost:3001/getItemsTable',postData,{ headers: { 'jwt': props.user[1] }})
      .then(res=>{
    ...
    <div className="testa" >
      <TableContainer component={Paper}>
        <div className="dbtableTitle">
          <p>{tableName}</p>
          <AddCircleIcon size="large" color='secondary' onClick={addItem}/>
        </div>
